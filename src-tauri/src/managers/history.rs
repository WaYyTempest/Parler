...
impl HistoryManager {
    ...
    pub fn save_entry(
        ...
        conn.execute(
            ...
            params![
                ...
                &post_processed_text,
                &post_process_prompt,
                post_process_action_key.map(i64::from),
                post_process_requested,
            ],
        )?;
    ...
    pub fn update_transcription(
        ...
        let entry = conn
            .query_row(
                "SELECT id, file_name, timestamp, saved, title, transcription_text, post_processed_text, post_process_prompt, post_process_action_key, post_process_requested
