 ...
 */
overlay_style?: OverlayStyle; long_audio_model?: string | null; long_audio_threshold_seconds?: number; post_process_actions?: PostProcessAction[]; saved_processing_models?: SavedProcessingModel[] }
...
export type HistoryEntry = { id: number; file_name: string; timestamp: number; saved: boolean; title: string; transcription_text: string; post_processed_text: string | null; post_process_prompt: string | null; post_process_action_key: number | null; post_process_requested: boolean }
