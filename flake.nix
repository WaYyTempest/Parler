{
  description = "Parler - A free, open source, and extensible speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          parler = pkgs.rustPlatform.buildRustPackage {
            pname = "parler";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/WaYyTempest/Parler";
          ...
          default = self.packages.${system}.parler;
        }
      );
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.parler.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.parler;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.parler.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.parler;
        };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Parler development environment"
              bun install
